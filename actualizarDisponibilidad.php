...
<div class="card-body">
	<form action="actualizarDispo.php" method="POST" autocomplete="off">
		<div class="row">
			...
			<div class="col-md-3">
				...
				<input type="date" name="fechaEntrega" class="form-control" value="<?=$datos['fechaEntrega']?>">
				<!--alerta para registros vacios-->
	...
	<div class="row">
		...
		<div class="btn btn-group-sm">
			...
			<a href="disponibilidad.php" onclick="alert('Por implementarse')"; type="button" class="btn btn-success" style="margin-right: 5px;">
