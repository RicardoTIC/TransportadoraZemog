...
<div class="card-footer">
	...
	<table id="table_id" class="table table-bordered table-hover">
		...
		<tr>
			...
			<td><a class="btn btn-warning" onclick="confirm('Deseas eliminar el registro');" class="botonSeleccionar" href="seleccionTalleres.php?id=<?php echo $rows['id']; ?>">Seleccionar</a></td>
		</tr>
	<?php endforeach; ?>
		</tbody>
	</table >	
