          ...
          <li class="nav-item dropdown">
            ...
            <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
              ...
              <li class="dropdown-submenu dropdown-hover disabled">
                <a id="dropdownSubMenu2" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="dropdown-item dropdown-toggle">Viaticos</a>
                <ul aria-labelledby="dropdownSubMenu2" class="dropdown-menu border-0 shadow">       
                  <!-- End Level three -->
                  <li><a href="talleres.php" class="dropdown-item disabled">Captura de Viaticos</a></li>
        ...
        <ul class="navbar-nav">
          <li class="nav-item dropdown ">
            ...
            <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
              ...
              <li><a href="categorias.php" class="dropdown-item">Agregar Categorias</a></li>
              <li><a href="sucursal.php" class="dropdown-item">Agregar Sucursales</a></li>
              <li><a href="operaciones.php" class="dropdown-item">Agregar Operacion</a></li>
