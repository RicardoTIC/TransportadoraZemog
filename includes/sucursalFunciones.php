...
class sucursalFunciones {
	...
	public function Actualizar($id,$nombre,$direccion,$telefono,$numeroLocalidad){
		//instancia de la clase conexion
		$conexion = new db();
		//sentencia SQL 
		$sql = "UPDATE sucursales SET nombreSucursal=:name,direccion=:direc,telefono=:tel,numeroLocalidad=:localidad WHERE id=:id";
